...
public class PorovnaniSouradnic {
    ...
    public PorovnaniSouradnic(ArrayList<ArrayList<ArrayList<HashMap<String, Double>>>> posouzeniPismenePngVsechRadkuKeVsemPismenABC){
        ...
        zdrojDataAbeceda pismenaABC = new zdrojDataAbeceda();
