...
public class PosouzeniSouradnic {
    ...
    public PosouzeniSouradnic(ArrayList<ArrayList<HashMap<String, Integer>>> MapaPismenAbeceda, ArrayList<ArrayList<ArrayList<HashMap<String, Integer>>>> MapaVsechPismenNaVsechRadcich){
        ...
        //********************************************
        json = new Gson().toJson(this.MapaVsechPismenNaVsechRadcich);
        jsonPopis = "thisMapaVsechPismenNaVsechRadcich.json";
        variableJson jsonThisMapaVsechPismenNaVsechRadcich = new variableJson(json, jsonPopis);
        //********************************************
        ...
        for (int r = 0; r < MapaVsechPismenNaVsechRadcich.size(); r++) {
            ...
            //********************************************
            json = new Gson().toJson(MapaVsechPismenNaJednomRadku);
            jsonPopis = "MapaVsechPismenNaJednomRadku-" + r + ".json";
            variableJson jsonMapaVsechPismenNaJednomRadku = new variableJson(json, jsonPopis);
            //********************************************
            ...
            for (int s = 0; s < MapaVsechPismenNaJednomRadku.size(); s++) {
                ...
                //********************************************
                json = new Gson().toJson(MapaPismeneZVybranehoSloupce);
                jsonPopis = "MapaPismeneZVybranehoSloupce-" + r + "-" + s + ".json";
                variableJson jsonMapaPismeneZVybranehoSloupce = new variableJson(json, jsonPopis);
                //********************************************
